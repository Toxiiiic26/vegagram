...
vegagram_API_DEST = "docs/source/api"

FUNCTIONS_PATH = "vegagram/raw/functions"
TYPES_PATH = "vegagram/raw/types"
BASE_PATH = "vegagram/raw/base"
...
def generate(source_path, base):
                ...
                with open(DESTINATION + "/" + full_path, "w", encoding="utf-8") as f:
                    f.write(
                        page_template.format(
                            ...
                            full_class_path="vegagram.raw.{}".format(
    ...
    for k, v in sorted(all_entities.items()):
        ...
        if k != base:
            ...
            module = "vegagram.raw.{}.{}".format(base, k)
        else:
            ...
            module = "vegagram.raw.{}".format(base)
...
def vegagram_api():
    ...
    root = vegagram_API_DEST + "/methods"
        ...
        for k, v in categories.items():
            ...
            for method in methods:
                with open(root + "/{}.rst".format(method), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: vegagram.Client.{}()".format(method))
            ...
            for func in functions:
                with open(root + "/{}.rst".format(func), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autofunction:: vegagram.{}()".format(func))
        ...
        for k, v in categories.items():
            ...
            for type in types:
                with open(root + "/{}.rst".format(type), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autoclass:: vegagram.types.{}()\n".format(type))
    ...
    root = vegagram_API_DEST + "/bound-methods"
        ...
        for k, v in categories.items():
            ...
            for bm in bound_methods:
                with open(root + "/{}.rst".format(bm), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: vegagram.types.{}()".format(bm))
        ...
        for k, v in categories.items():
            ...
            for enum in enums:
                with open(root + "/{}.rst".format(enum), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autoclass:: vegagram.enums.{}()".format(enum))
                    f2.write("\n    :members:\n")
