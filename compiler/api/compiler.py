...
DESTINATION_PATH = Path("vegagram/raw")
NOTICE_PATH = "NOTICE"
...
def get_docstring_arg_type(t: str):
    if t in CORE_TYPES:
        ...
        return "Any object from :obj:`~vegagram.raw.types`"
    elif t == "!X":
        return "Any function from :obj:`~vegagram.raw.functions`"
    elif t.lower().startswith("vector"):
        return "List of " + get_docstring_arg_type(t.split("<", 1)[1][:-1])
    else:
        return f":obj:`{t} <vegagram.raw.base.{t}>`"
...
def start(format: bool = False):
    ...
    for qualtype in types_to_constructors:
        ...
        docstring += f"\n\n    Constructors:\n" \
                     ...
                     f"        .. currentmodule:: vegagram.raw.types\n\n" \
                     f"        .. autosummary::\n" \
                     f"            :nosignatures:\n\n" \
                     f"            {items}"
        ...
        if references:
            docstring += f"\n\n    Functions:\n        This object can be returned by " \
                         ...
                         f"        .. currentmodule:: vegagram.raw.functions\n\n" \
                         f"        .. autosummary::\n" \
                         f"            :nosignatures:\n\n" \
                         f"            " + references
    ...
    for c in combinators:
        ...
        if c.section == "types":
            ...
            docstring += f"\n    Constructor of :obj:`~vegagram.raw.base.{c.qualtype}`."
        else:
    ...
    with open(DESTINATION_PATH / "all.py", "w", encoding="utf-8") as f:
        ...
        for c in combinators:
            f.write(f'\n    {c.id}: "vegagram.raw.{c.section}.{c.qualname}",')

        f.write('\n    0xbc799737: "vegagram.raw.core.BoolFalse",')
        f.write('\n    0x997275b5: "vegagram.raw.core.BoolTrue",')
        f.write('\n    0x1cb5c415: "vegagram.raw.core.Vector",')
        f.write('\n    0x73f1f8dc: "vegagram.raw.core.MsgContainer",')
        f.write('\n    0xae500895: "vegagram.raw.core.FutureSalts",')
        f.write('\n    0x0949d9dc: "vegagram.raw.core.FutureSalt",')
        f.write('\n    0x3072cfa1: "vegagram.raw.core.GzipPacked",')
        f.write('\n    0x5bb8e511: "vegagram.raw.core.Message",')
