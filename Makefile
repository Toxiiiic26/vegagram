...
TAG = v$(shell grep -E '__version__ = ".*"' vegagram/__init__.py | cut -d\" -f2)
...
clean-api:
	$(RM) vegagram/errors/exceptions vegagram/raw/all.py vegagram/raw/base vegagram/raw/functions vegagram/raw/types
