...
import vegagram
from vegagram.types.messages_and_media.message import Str
from vegagram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~vegagram.types.PollOption`):
        ...
        question_entities (List of :obj:`~vegagram.types.MessageEntity`, *optional*):
            Special entities like usernames, URLs, bot commands, etc. that appear in the question.

        explanation (``str``, *optional*):
            Text that is shown when a user chooses an incorrect answer or taps on the lamp icon in a quiz-style poll,
            0-200 characters.

        explanation_entities (List of :obj:`~vegagram.types.MessageEntity`, *optional*):
        ...
        voter (:obj:`~vegagram.types.User`, *optional*):
    ...
    def _parse(client, media_poll: Union["raw.types.MessageMediaPoll", "raw.types.UpdateMessagePoll"]) -> "Poll":
        ...
        return Poll(
            id=str(poll.id),
            question=Str(poll.question.text).init(
                types.List(
                    filter(
                        lambda x: x is not None,
                        [
