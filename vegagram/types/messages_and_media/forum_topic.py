...
import vegagram
from vegagram import types, raw, utils
...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        creator (:obj:`~vegagram.types.Chat`, *optional*):
            Topic creator.

        top_message (:obj:`~vegagram.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "vegagram.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
        if not forum_topic:
            return None
