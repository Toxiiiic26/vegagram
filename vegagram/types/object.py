...
class Object:
    def __init__(self, client: "vegagram.Client" = None):
        self._client = client

    def bind(self, client: "vegagram.Client"):
        """Bind a Client instance to this and to all nested vegagram objects.

        Parameters:
            client (:obj:`~vegagram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing vegagram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/vegagramchat/167281
