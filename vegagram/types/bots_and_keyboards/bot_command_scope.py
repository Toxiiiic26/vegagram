...
class BotCommandScope(Object):
    ...
    - :obj:`~vegagram.types.BotCommandScopeDefault`
    - :obj:`~vegagram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~vegagram.types.BotCommandScopeAllGroupChats`
    - :obj:`~vegagram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~vegagram.types.BotCommandScopeChat`
    - :obj:`~vegagram.types.BotCommandScopeChatAdministrators`
    - :obj:`~vegagram.types.BotCommandScopeChatMember`
