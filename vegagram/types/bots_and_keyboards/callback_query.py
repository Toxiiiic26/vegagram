...
from vegagram.errors import ChannelPrivate
...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~vegagram.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <vegagram.Filters.regex>`.
    """
    ...
    @staticmethod
    async def _parse(client: "vegagram.Client", callback_query, users, chats) -> "CallbackQuery":
        message = None
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`~vegagram.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~vegagram.types.CallbackQuery`.
        ...
        Returns:
            :obj:`~vegagram.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~vegagram.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~vegagram.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~vegagram.types.CallbackQuery`.
