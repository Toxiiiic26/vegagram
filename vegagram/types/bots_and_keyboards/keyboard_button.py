...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_poll (:obj:`~vegagram.types.RequestPollInfo`, *optional*):
            If specified, the poll be sent when the button is pressed.

        request_peer (:obj:`~vegagram.types.RequestChannelInfo` | :obj:`~vegagram.types.RequestChatInfo` | :obj:`~vegagram.types.RequestUserInfo`, *optional*):
