...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~vegagram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~vegagram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~vegagram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~vegagram.types.CallbackGame`, *optional*):
        ...
        pay (``bool``, *optional*):
            ...
            Available in :meth:`~vegagram.Client.send_invoice`.
