...
class PrivacyRule(Object):
    ...
    Parameters:
        ...
        allow_premium (``bool``, *optional*):
            Allow only users with a Premium subscription, currently only usable for :obj:`~vegagram.enums.PrivacyKey.CHAT_INVITE`.

        allow_users (``bool``, *optional*):
            Allow only participants of certain users.

        users (List of :obj:`~vegagram.types.User`, *optional*):
            List of users.

        chats (List of :obj:`~vegagram.types.Chat`, *optional*):
            List of chats.
    """
