...
import vegagram
from vegagram import raw, types, utils, enums
...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~vegagram.enums.ChatMemberStatus`):
        ...
        invited_by (:obj:`~vegagram.types.User`, *optional*):
        ...
        promoted_by (:obj:`~vegagram.types.User`, *optional*):
            Administrators only. Information about the user who promoted this member as administrator.

        restricted_by (:obj:`~vegagram.types.User`, *optional*):
