...
class BusinessInfo(Object):
    ...
    Parameters:
        ...
        greeting_message (:obj:`~vegagram.types.BusinessMessage`, *optional*):
            Greeting message of the business.

        away_message (:obj:`~vegagram.types.BusinessMessage`, *optional*):
            Away message of the business.

        working_hours (:obj:`~vegagram.types.BusinessWorkingHours`, *optional*):
