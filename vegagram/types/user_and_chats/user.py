...
import vegagram
from vegagram import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~vegagram.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~vegagram.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~vegagram.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~vegagram.types.EmojiStatus`, *optional*):
            Emoji status.
        ...
        raw (:obj:`~vegagram.raw.base.User` | :obj:`~vegagram.raw.base.UserStatus`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~vegagram.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~vegagram.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~vegagram.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~vegagram.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~vegagram.types.User`.
