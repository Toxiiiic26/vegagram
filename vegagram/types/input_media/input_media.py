...
class InputMedia(Object):
    ...
    - :obj:`~vegagram.types.InputMediaAnimation`
    - :obj:`~vegagram.types.InputMediaDocument`
    - :obj:`~vegagram.types.InputMediaAudio`
    - :obj:`~vegagram.types.InputMediaPhoto`
    - :obj:`~vegagram.types.InputMediaVideo`
    """
