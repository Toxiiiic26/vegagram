...
import vegagram
from vegagram import raw, types, enums
...
class SetPrivacy:
    async def set_privacy(
        ...
        Parameters:
            key (:obj:`~vegagram.enums.PrivacyKey`):
                Privacy key.

            rules (Iterable of :obj:`~vegagram.types.InputPrivacyRule`):
                List of privacy rules.

        Returns:
            List of :obj:`~vegagram.types.PrivacyRule`: On success, the list of privacy rules is returned.

        Example:
            .. code-block:: python

                from vegagram import enums, types
