...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~vegagram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.ChatMemberUpdatedHandler(func, self),
