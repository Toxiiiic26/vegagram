...
class OnPreCheckoutQuery:
    def on_pre_checkout_query(
        ...
        :obj:`~vegagram.handlers.PreCheckoutQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.PreCheckoutQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.PreCheckoutQueryHandler(func, self),
