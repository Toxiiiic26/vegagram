...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~vegagram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.ChosenInlineResultHandler(func, self),
