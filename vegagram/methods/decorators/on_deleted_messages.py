...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~vegagram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.DeletedMessagesHandler(func, self),
