...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~vegagram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.CallbackQueryHandler(func, self),
