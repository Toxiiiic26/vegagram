...
class OnMessageReactionCount:
    def on_message_reaction_count(
        ...
        :obj:`~vegagram.handlers.MessageReactionCountHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.MessageReactionCountHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.MessageReactionCountHandler(func, self),
