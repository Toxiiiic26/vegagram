...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~vegagram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.EditedMessageHandler(func, self),
