...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~vegagram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.ChatJoinRequestHandler(func, self),
