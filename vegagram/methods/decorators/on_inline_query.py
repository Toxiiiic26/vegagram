...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~vegagram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.InlineQueryHandler(func, self),
