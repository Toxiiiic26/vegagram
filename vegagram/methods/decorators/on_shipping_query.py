...
class OnShippingQuery:
    def on_shipping_query(
        ...
        :obj:`~vegagram.handlers.ShippingQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, vegagram.Client):
                self.add_handler(vegagram.handlers.ShippingQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        vegagram.handlers.ShippingQueryHandler(func, self),
