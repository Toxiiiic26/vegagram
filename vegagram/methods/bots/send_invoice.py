...
import vegagram
from vegagram import enums, raw, utils, types
...
class SendInvoice:
    async def send_invoice(
        ...
        Parameters:
            ...
            prices (List of :obj:`~vegagram.types.LabeledPrice`):
        ...
        Returns:
            :obj:`~vegagram.types.Message`: On success, the sent invoice message is returned.
