...
from vegagram.errors import PhoneMigrate, NetworkMigrate
from vegagram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~vegagram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
