...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~vegagram.types.InputMediaPhoto`, :obj:`~vegagram.types.InputMediaVideo`, :obj:`~vegagram.types.InputMediaAudio` and :obj:`~vegagram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~vegagram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from vegagram.types import InputMediaPhoto, InputMediaVideo
