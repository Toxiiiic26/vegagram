...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~vegagram.Client.search_global_count`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~vegagram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "vegagram". Get the first 50 results
                async for message in app.search_global("vegagram", limit=50):
                    print(message.text)
