...
from vegagram.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~vegagram.types.Message` | :obj:`~vegagram.types.Story` | ``str``):
        ...
        Returns:
            ...
            :meth:`~vegagram.Client.stop_transmission`, None is returned.
