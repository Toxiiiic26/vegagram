...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~vegagram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~vegagram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~vegagram.Client.stop_transmission`, None is returned.
