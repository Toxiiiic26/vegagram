...
import vegagram
from vegagram import enums, raw, types, utils, StopTransmission
from vegagram.errors import FilePartMissing
...
class SendStory:
    async def send_story(
        ...
        Returns:
            :obj:`~vegagram.types.Story` a single story is returned.
