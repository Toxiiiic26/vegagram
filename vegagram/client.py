...
import vegagram
from vegagram import __version__, __license__
from vegagram import enums
from vegagram import raw
from vegagram import utils
from vegagram.crypto import aes
from vegagram.errors import CDNFileHashMismatch
from vegagram.errors import (
...
from vegagram.handlers.handler import Handler
from vegagram.methods import Methods
from vegagram.session import Auth, Session
from vegagram.storage import Storage, FileStorage, MemoryStorage
from vegagram.types import User, TermsOfService
from vegagram.utils import ainput
...
class Client(Methods):
    """vegagram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~vegagram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where vegagram will store the session files.
        ...
        storage_engine (:obj:`~vegagram.storage.Storage`, *optional*):
        ...
        client_platform (:obj:`~vegagram.enums.ClientPlatform`, *optional*):
            The platform where this client is running.
            Defaults to 'other'

        init_connection_params (:obj:`~vegagram.raw.base.JSONValue`, *optional*):
            Additional initConnection parameters.
            For now, only the tz_offset field is supported, for specifying timezone offset in seconds.
    """

    APP_VERSION = f"vegagram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to vegagram (version {__version__})")
        print(f"vegagram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~vegagram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.vegagram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except vegagram.StopTransmission:
                raise
