...
from vegagram.types import Message, CallbackQuery, InlineQuery, PreCheckoutQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "vegagram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~vegagram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~vegagram.handlers.MessageHandler` the *update* argument will be a :obj:`~vegagram.types.Message`; in a :obj:`~vegagram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~vegagram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~vegagram.filters.command` or :meth:`~vegagram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~vegagram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.GiveawayWinners` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.GiftCode` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.StarGift` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Dice` objects."""
...
"""Filter messages that contain :obj:`~vegagram.types.Story` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~vegagram.types.Message`.
    ...
    async def func(flt, client: vegagram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~vegagram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~vegagram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~vegagram.types.InlineQuery`: The filter will match ``query``.
    - :obj:`~vegagram.types.PreCheckoutQuery`: The filter will match ``payload``.
